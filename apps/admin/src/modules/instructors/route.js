...
router.post('/', (0, lib_1.validate)(schemas_1.InstructorSaveSchema), controller_1.create);
router.put('/:id', (0, lib_1.validate)(schemas_1.InstructorSaveSchema), controller_1.update);
