...
exports.create = (0, lib_1.asyncHandler)(async (req, res) => {
    mainController_1.mainController.create(req, res, models_1.Review);
});
exports.update = (0, lib_1.asyncHandler)(async (req, res) => {
    mainController_1.mainController.update(req, res, models_1.Review);
});
exports.list = (0, lib_1.asyncHandler)(async (req, res) => {
    mainController_1.mainController.list(req, res, models_1.Review);
});
exports.read = (0, lib_1.asyncHandler)(async (req, res) => {
    mainController_1.mainController.read(req, res, models_1.Review);
});
exports.remove = (0, lib_1.asyncHandler)(async (req, res) => {
    mainController_1.mainController.remove(req, res, models_1.Review);
});
