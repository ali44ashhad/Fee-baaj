...
export default function Loading() {
  ...
  return (
    <main className="min-h-screen w-full mt-[14%] h-full bg-[url('/cover-homepage.webp')] bg-repeat bg-center">
      <div className="max-w-[600px] w-[600px] sm:w-full mx-auto lg:px-4 py-4 sm:py-0 space-y-6">
        {[1, 2, 3].map((_, i) => (
          <div key={i} className="bg-white rounded-2xl shadow-md p-4 space-y-4">
